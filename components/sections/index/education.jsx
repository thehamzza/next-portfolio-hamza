...
/**
 * Section: Education
 * An overview of your educational background.
 * Highlight your academic journey and relevant coursework.
 * 
		...
		<Section classProp={about.section}>	
			<Container spacing={['verticalXXXLrg']}>
				...
				<section className={about.content}>
					...
					<div className={about.image}>
						<img 
							src="/img/hamza-powerlifting-winner.jpeg" 
							alt="Hamza at Powerlifting Meet"
